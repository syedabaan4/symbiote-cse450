  ...
  Future<void> _showDeleteDialog(BuildContext context, String threadId) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Are you sure you want to delete this thread? This will delete all thoughts in this thread and cannot be undone.',
        ),
        actions: [
          TextButton(
